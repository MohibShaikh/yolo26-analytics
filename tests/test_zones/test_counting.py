...
class TestZoneCounting:
    def _zone(self) -> Zone:
        return Zone(
            name="test", polygon=[(0, 0), (200, 0), (200, 200), (0, 200)], track_classes=["person"]
        )
    ...
    def test_counts_tracks_in_zone(self) -> None:
        ...
        tracks = [
            Track(
                track_id=1,
                detection=Detection(bbox=(50, 50, 150, 150), confidence=0.9, class_name="person"),
            ),
            Track(
                track_id=2,
                detection=Detection(bbox=(300, 300, 400, 400), confidence=0.8, class_name="person"),
            ),
        ]
    ...
    def test_ignores_untracked_classes(self) -> None:
        ...
        tracks = [
            Track(
                track_id=1,
                detection=Detection(bbox=(50, 50, 150, 150), confidence=0.9, class_name="car"),
            )
        ]
        count = counter.update(zone, tracks)
        assert count == {}
